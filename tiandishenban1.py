...
def get_tiandishenban_stock():
    try:
        ...
        querystr = '''
          ...
          WHERE DATE(a.recommand_time) = (SELECT MAX(DATE(recommand_time)) FROM stock_app.t_reversal_history)
        '''
        #执行sql语句
...
if __name__ == '__main__':
    ...
    if(len(data) > 0):
        ...
        #pushcomm.jpush2topic(pushcomm.app_key, pushcomm.master_secret, "股票先机", app_push_str, "reverse_king",{'type': 4, 'linkUrl': 'gpxj://reverse_king'})
